...
declare
  ...
  v_roles jsonb := jsonb_build_array(
    ...
    jsonb_build_object('id', 'role-warehouse', 'key', 'warehouse', 'name', 'Deposito', 'permissions', jsonb_build_array('dashboard:view','products:view','purchases:view','tickets:view','reports:view','products:write','products:adjust','products:transfer','purchases:write','tickets:write'))
  );
begin
  select *
  into v_session
